...
class databasemongo {
    /** @var \ecoaragonapp\common\databasemongo[] $_singleton database object */
    private static $_singleton = [];
    const DATABASE_ID = 'mongodb';

    /**
     * @var array|null|\ecoaragonapp\common\databasemongo[] $_databases database object array like:
     * <br/>
     *      - id: database id
    ...
    private function load_config() {
        if ( $this->_databases === null ) {
            ...
            $this->_databases[ 'mongodb' ] = new databasemongoconnection(
                ...
                'ecoaragonapp', // database user
                file_get_contents( __DIR__ . '/../config/mongodb.key' ), // database password
                'ecoaragonapp' //database to be selected
            );
     ...
     * @return \ecoaragonapp\common\databasemongo Objeto controlador de base de datos
     */
